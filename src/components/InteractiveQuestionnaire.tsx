...
export const InteractiveQuestionnaire: React.FC<InteractiveQuestionnaireProps> = ({
  ...
  const handleRandomizeAll = () => {
    ...
    // Names, clubs, etc. to pick randomly
    const names = [
      "Enzo Lombardi", "Mateo Silva", "Giovanni Rossi", "Filippo Mancini", "Arthur Lima", 
      "Hugo Santos", "Bernardo Neves", "Santiago Castro", "Lucas Alcaraz", "Maxime Dubois",
      "Kylian Laurent", "Jude Sterling", "Marcus Rashford", "Alessandro Bastoni", "Thiago Almada",

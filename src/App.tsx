...
export default function App() {
  ...
  // Selected Victim Team Modal State
  ...
  const getVictimTeams = () => {
    ...
    career.matches.forEach(m => {
      ...
      if (m.goalDetails) {
        team.pd += (m.goalDetails.pd || 0);
        team.pe += (m.goalDetails.pe || 0);
        team.da += (m.goalDetails.da || 0);
        team.fa += (m.goalDetails.fa || 0);
      }
                ...
                <div className="bg-[#0c0c0e] border border-white/5 rounded-3xl p-6 space-y-5">
                  <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 border-b border-white/5 pb-4">
                    <div className="flex items-center gap-2.5">
                      ...
                      <div>
                        <span className="text-[8px] font-mono text-zinc-500 block uppercase tracking-widest">Estatísticas de Confrontos Diretos</span>
                        <h2 className="font-display font-bold text-md text-white uppercase italic tracking-tight flex items-center gap-2">
                          Times Carrasco (Maiores Vítimas) 🔥
                        </h2>
                      </div>
                    </div>

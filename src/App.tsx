...
export default function App() {
  ...
  const [userProfile, setUserProfile] = useState<{ username?: string; hasSetupUsername?: boolean } | null>(null);
  ...
  useEffect(() => {
    const unsubscribe = onAuthStateChanged(auth, async (user) => {
      ...
      if (user) {
        ...
        // Fetch user profile to enforce mandatory username handle
        try {
          ...
          console.error("Erro ao verificar cadastro de username:", uerr);
          setShowUsernameModal(true);
        }
